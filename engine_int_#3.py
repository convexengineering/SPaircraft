...
from basic_HT import BasicHT as HorizontalTail
from basic_HT import BasicHTPerformance as HorizontalTailPerformance
...
class Aircraft(Model):
    ...
    def setup(self, Nclimb, Ncruise, enginestate, **kwargs):
        ...
        Lhmax = Variable('L_{{max}_h}','N','Horizontal tail maximum downforce')
...
if __name__ == '__main__':
    ...
    ##        'A_2': np.pi*(.5*1.75)**2, # Engine inlet area substitution
        ...
        #dict of initial engine guesses
    x0 = {
