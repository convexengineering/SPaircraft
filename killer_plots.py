...
def standard_killer_plot():
    ...
    for i in range(0, 6):
        ...
        substitutions.update({'R_{req}': 3000. * units('nmi'),
                              'n_{pass}': 180.})
        sol[i] = optimize_aircraft(m, substitutions, fixedBPRList[i], pRatOptList[i],
                                   solver='mosek_conif')
    ...
    xtest = [0, 1, 2, 3, 4, 5]
    xlabels = ['Optimized 737-800 M = 0.8', 'Slow to M = 0.72', 'D8 fuselage, Pi tail', 'Rear podded engines',
    ...
    plt.plot([0, 1, 2, 3, 4, 5, 6],
             [1, 41129. / 43843, 38402. / 43843, 37180. / 43843, 32987. / 43843, 32383. / 43843, 29753. / 43843], "o--")
