...
Allowing negative dual variable(s) as small as -2.26803145231e-12.
Solving took 7 GP solves and 1.38 seconds.
...
--------------
   ...
   E_{land} : 3.809e+05  [J]    Max KE to be absorbed in landing                
    ...
    F_{w_n} : 643.7             Weight factor (nose)                            
        I_m : 7.943e-06  [m**4] Area moment of inertia (main strut)             
...
L_{n_{dyn}} : 7.781e+04  [N]    Dyn. braking load, nose gear                    
  ...
  W_{add_n} : 822.2      [N]    Proportional added weight, nose                 
     ...
     W_{ns} : 127.3      [N]    Weight of nose strut                            
...
d_{nacelle} : 2.05       [m]    Nacelle diameter                                
   ...
   l_{oleo} : 0.7399     [m]    Length of oleo shock absorber                   
        r_m : 0.06812    [m]    Radius of main gear struts                      
        r_n : 0.04351    [m]    Radius of nose gear struts                      
        t_m : 0.007997   [m]    Thickness of main gear strut wall               
        t_n : 0.003715   [m]    Thickness of nose gear strut wall               
...
-------------
    ...
    \lambda_{LG} : 0.08561  Ratio of max to static load              
         d_{fan} : 0.07757  Fan diameter                             
