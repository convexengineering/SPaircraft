...
Solving took 5 GP solves and 0.583 seconds.
...
Free Variables
--------------
               AR_w : 9.322 Wing aspect ratio 
            C_{D_w} : 0.0169 Drag coefficient, wing
...
\bar{A}_{fuel, max} : 0.069 Non-dim. fuel area
          \bar{c}_w : 4.469  [m] Mean aerodynamic chord (wing)
      ...
      y_{\bar{c}_w} : 10.37  [m] Spanwise location of mean aerodynamic chord
...
\sigma_{max,shear} : -0.03093 Allowable shear stress
      ...
      C_{L_{wmax}} : 0.497    Max lift coefficient, wing
                 g : 0.4332   Gravitational acceleration
          W_{fuel} : 0.207    Fuel weight           
     \tan(\Lambda) : 0.1221   Tangent of quarter-chord sweep angle
               \mu : -0.05124 Dynamic viscosity (35,000 ft)
                 w : -0.06373 Wingbox-width-to-chord ratio
