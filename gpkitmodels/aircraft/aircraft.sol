...
Solving took 8 GP solves and 4.83 seconds.
...
--------------
                         Aircraft |                                                                       
                              C_D : 0.06762              Drag coefficient                                 
                              C_L : 0.398                Lift coefficient                                 
                          C_{L_w} : 0.398                Lift coefficient (wing)                          
                       C_{L_{aw}} : 3.98                 Lift curve slope (wing)                          
                                D : 1.141e+05  [N]       Total aircraft drag (cruise)                     
                         D_{fuse} : 1.307e+04  [N]       Fuselage drag                                    
                           D_{ht} : 916.4      [N]       Horizontal tail drag                             
                           D_{vt} : 984        [N]       Vertical tail drag                               
                         D_{wing} : 9.912e+04  [N]       Wing drag                                        
                              L_w : 6.715e+05  [N]       Wing lift                                        
                      L_{v_{max}} : 6.263e+05  [N]       Maximum load for structural sizing               
                              S_w : 162.2      [m**2]    Wing reference area                              
                           V_{TO} : 62.4       [m/s]     Takeoff speed                                    
                                W : 6.715e+05  [N]       Total aircraft weight                            
                         W_{fuel} : 1.916e+05  [N]       Fuel weight                                      
                         W_{fuse} : 1.645e+05  [N]       Fuselage weight                                  
                           W_{ht} : 1882       [N]       Horizontal tail weight                           
                           W_{lg} : 1.618e+04  [N]       Weight of landing gear                           
                          W_{pay} : 1.616e+05  [N]       Payload weight                                   
                           W_{vt} : 1121       [N]       Vertical tail weight                             
                         W_{wing} : 1.247e+05  [N]       Wing weight                                      
                           W_{zf} : 4.8e+05    [N]       Zero fuel weight                                 
                   \bar{c}_{wing} : 6.092      [m]       Mean aerodynamic chord (wing)                    
                      \frac{L}{D} : 5.886                Lift/drag ratio                                  
                              \xi : 0.2028               Takeoff parameter                                
                           b_{vt} : 3.199      [m]       Vertical tail span                               
                           c_{vt} : 9.122      [m]       Vertical tail root chord                         
                         h_{hold} : 0.904      [m]       Hold height                                      
                         l_{fuse} : 62.4       [m]       Fuselage length                                  
                    p_{\lambda_v} : 1.6                  1 + 2*Tail taper ratio                           
                         w_{fuse} : 3.969      [m]       Fuselage width                                   
                              x_w : 22.04      [m]       Position of wing aerodynamic center              
                     x_{CG_{eng}} : 22.04      [m]       x-location of engine CG                          
                      x_{CG_{fu}} : 17.58      [m]       x-location of fuselage CG                        
                      x_{CG_{ht}} : 61         [m]       Horizontal tail CG location                      
                      x_{CG_{lg}} : 22.08      [m]       x-location of landing gear CG                    
                      x_{CG_{vt}} : 57.84      [m]       x-location of tail CG                            
                    x_{CG_{wing}} : 22.04      [m]       x-location of wing CG                            
               ...
               Fuselage, Aircraft |                                                                       
                        A_{floor} : 0.06255    [m**2]    Floor beam x-sectional area                      
                         A_{fuse} : 12.37      [m**2]    Fuselage x-sectional area                        
                         A_{hold} : 2.174      [m**2]    Cargo hold x-sectional area                      
                         A_{skin} : 0.01244    [m**2]    Skin cross sectional area                        
                     D_{friction} : 1.205e+04  [N]       Friction drag                                    
                      D_{upsweep} : 1019       [N]       Drag due to fuse upsweep                         
                               FF : 1.055                Fuselage form factor                             
                        M_{floor} : 4.874e+05  [N*m]     Max bending moment in floor beams                
                        P_{floor} : 1.137e+06  [N]       Distributed floor load                           
                         R_{fuse} : 1.985      [m]       Fuselage radius                                  
                         S_{bulk} : 24.75      [m**2]    Bulkhead surface area                            
                        S_{floor} : 5.686e+05  [N]       Maximum shear in floor beams                     
                         S_{nose} : 53.63      [m**2]    Nose surface area                                
                         V_{bulk} : 0.02469    [m**3]    Bulkhead skin volume                             
                        V_{cabin} : 361.6      [m**3]    Cabin volume                                     
                        V_{cargo} : 6.796      [m**3]    Cargo volume                                     
                         V_{cone} : 0.1304     [m**3]    Cone skin volume                                 
                          V_{cyl} : 0.3037     [m**3]    Cylinder skin volume                             
                        V_{floor} : 0.2145     [m**3]    Floor volume                                     
                         V_{hold} : 53.07      [m**3]    Hold volume                                      
                        ...
                        W_{shell} : 1.821e+04  [N]       Shell weight                                     
                  ...
                  \sigma_{\theta} : 1.034e+08  [N/m**2]  Skin hoop stress                                 
                      \tau_{cone} : 1.034e+08  [N/m**2]  Shear stress in cone                             
                                f : 15.72                Fineness ratio                                   
                        h_{floor} : 0.08064    [m]       Floor I-beam height                              
                         l_{cone} : 22.8       [m]       Cone length                                      
                        ...
                        t_{shell} : 0.001347   [m]       Shell thickness                                  
                         t_{skin} : 0.0009976  [m]       Skin thickness                                   
                        w_{floor} : 3.429      [m]       Floor width                                      
                           xVbulk : 0.7311     [m**4]    Volume moment of bulkhead                        
                            xVcyl : 5.285      [m**4]    Volume moment of cylinder                        
                           xVnose : 0.1391     [m**4]    Volume moment of nose                            
                            xWapu : 2.069e+05  [N*m]     Moment of APU                                    
                           xWcone : 2.861e+05  [N*m]     Moment of cone                                   
                            xWfix : 2.802e+04  [N*m]     Moment of fixed weights                          
                          xWfloor : 2.005e+05  [N*m]     Moment of floor weight                           
                           xWfuse : 2.891e+06  [N*m]     Fuselage moment                                  
                          xWinsul : 8.061e+04  [N*m]     Moment of insulation material                    
                           xWpadd : 1.125e+06  [N*m]     Moment of misc weights                           
                           xWseat : 4.856e+05  [N*m]     Moment of seats                                  
                          xWshell : 2.935e+05  [N*m]     Mass moment of shell                             
                           xWskin : 1.63e+05   [N*m]     Mass moment of skin                              
         ...
         HorizontalTail, Aircraft |                                                                       
                             AR_h : 4.455                Horizontal tail aspect ratio                     
                          C_{D_h} : 0.007018             Horizontal tail drag coefficient                 
                      C_{D_{0_h}} : 0.005302             Horizontal tail parasitic drag coefficient       
                          C_{L_h} : 0.1538               Lift coefficient (htail)                         
                       C_{L_{ah}} : 3.65                 Lift curve slope (htail)                         
                              K_f : 0.4105               Empirical factor for fuselage-wing interference  
                              L_h : 2.009e+04  [N]       Horizontal tail downforce                        
                      L_{{max}_h} : 4.145e+05  [N]       Maximum load                                     
                         Re_{c_h} : 1.224e+07            Cruise Reynolds number (Horizontal tail)         
                             S.M. : 0.05                 Stability margin                                 
                              S_h : 12.55      [m**2]    Horizontal tail area                             
              \Delta x_{{lead}_h} : 39.56      [m]       Distance from CG to horizontal tail leading edge 
             \Delta x_{{trail}_h} : 42.36      [m]       Distance from CG to horizontal tail trailing edge
                           \alpha : 0.04214              Horizontal tail angle of attack                  
                     \bar{c}_{ht} : 1.927      [m]       Mean aerodynamic chord (ht)                      
                        \lambda_h : 0.2                  Horizontal tail taper ratio                      
                           \tau_h : 0.15                 Horizontal tail thickness/chord ratio            
                           b_{ht} : 7.478      [m]       Horizontal tail span                             
                       c_{root_h} : 2.798      [m]       Horizontal tail root chord                       
                      ...
                      L_{n_{dyn}} : 5.8e+04    [N]       Dyn. braking load, nose gear                     
                          ...
                          L_{w_n} : 8.044e+04  [N]       Static load per wheel (nose)                     
                             S_sa : 0.2959     [m]       Stroke of the shock absorber                     
                                T : 5.634      [m]       Main landing gear track                          
                           W_{mg} : 1.469e+04  [N]       Weight of main gear                              
                           W_{ms} : 1403       [N]       Weight of main struts                            
                           W_{mw} : 2377       [N]       Weight of main wheels (per strut)                
                           W_{ng} : 1487       [N]       Weight of nose gear                              
                           W_{ns} : 116.7      [N]       Weight of nose strut                             
                       ...
                       \Delta x_m : 3.761      [m]       Distance b/w main gear and CG                    
                       \Delta x_n : 15.04      [m]       Distance b/w nose gear and CG                    
                      ...
                      d_{nacelle} : 2.05       [m]       Nacelle diameter                                 
                         d_{oleo} : 0.3735     [m]       Diameter of oleo shock absorber                  
                          ...
                          d_{t_n} : 35.6       [in]      Diameter of nose gear tires                      
                              l_m : 2.374      [m]       Length of main gear                              
           ...
           VerticalTail, Aircraft |                                                                       
                          A_{fan} : 2.405      [m**2]    Engine reference area                            
                           A_{vt} : 0.5395               Vertical tail aspect ratio                       
                      C_{D_{vis}} : 0.004987             Viscous drag coefficient                         
                       C_{L_{vt}} : 0.3653               Vertical tail lift coefficient                   
                           D_{wm} : 3112       [N]       Engine out windmill drag                         
                     L_{max_{vt}} : 1.253e+06  [N]       Maximum load for structural sizing               
                           L_{vt} : 1.793e+04  [N]       Vertical tail lift in engine out                 
                          Re_{vt} : 4.13e+07             Vertical tail reynolds number, cruise            
                                S : 37.93      [m**2]    Vertical tail reference area (full)              
                           S_{vt} : 18.97      [m**2]    Vertical tail ref. area (half)                   
                       W_{struct} : 2241       [N]       Full span weight                                 
                  \Delta x_{lead} : 33.24      [m]       Distance from CG to vertical tail leading edge   
                 \Delta x_{trail} : 42.36      [m]       Distance from CG to vertical tail trailing edge  
                     \bar{c}_{vt} : 6.502      [m]       Vertical tail mean aero chord                    
                     \lambda_{vt} : 0.3                  Vertical tail taper ratio                        
                        \tau_{vt} : 0.1325               Vertical tail thickness/chord ratio              
                                b : 6.398      [m]       Span                                             
                    c_{root_{vt}} : 9.122      [m]       Vertical tail root chord                         
                     c_{tip_{vt}} : 2.737      [m]       Vertical tail tip chord                          
                           l_{vt} : 35.59      [m]       Vertical tail moment arm                         
                           p_{vt} : 1.6                  Substituted variable = 1 + 2*taper               
                           q_{vt} : 1.3                  Substituted variable = 1 + taper                 
                 z_{\bar{c}_{vt}} : 0.8664     [m]       Vertical location of mean aerodynamic chord      
                   ...
                   Wing, Aircraft |                                                                       
                      ...
                      L_{max_{w}} : 5.149e+06  [N]       Maximum load                                     
                         ...
                         c_{root} : 8.844      [m]       Wing root chord                                  
                          c_{tip} : 1.769      [m]       Wing tip chord                                   
                              e_w : 0.981                Oswald efficiency factor                         
                     f(\lambda_w) : 0.0033               Empirical efficiency function of taper           
                      ...
                      y_{\bar{c}} : 8.819      [m]       Spanwise location of mean aerodynamic chord      
                                                                                                          
WingBox, HorizontalTail, Aircraft |                                                                       
                          I_{cap} : 8.257e-06            Non-dim spar cap area moment of inertia          
                              M_r : 1.077e+05  [N]       Root moment per root chord                       
                          W_{cap} : 1141       [N]       Weight of spar caps                              
                          W_{web} : 203.2      [N]       Weight of shear web                              
                              \nu : 0.8612               Dummy variable = $(t^2 + t + 1)/(t+1)$           
                          t_{cap} : 0.00178              Non-dim. spar cap thickness                      
                          t_{web} : 0.001409             Non-dim. shear web thickness                     
                                                                                                          
  WingBox, VerticalTail, Aircraft |                                                                       
                                A : 1.079                Aspect ratio                                     
                          I_{cap} : 5.74e-07             Non-dim spar cap area moment of inertia          
                              M_r : 9.011e+04  [N]       Root moment per root chord                       
                          W_{cap} : 1012       [N]       Weight of spar caps                              
                          W_{web} : 589        [N]       Weight of shear web                              
                              \nu : 0.8225               Dummy variable = $(t^2 + t + 1)/(t+1)$           
                          t_{cap} : 0.0001549            Non-dim. spar cap thickness                      
                          t_{web} : 0.0004535            Non-dim. shear web thickness                     
                                                                                                          
          WingBox, Wing, Aircraft |                                                                       
                          I_{cap} : 1.381e-05            Non-dim spar cap area moment of inertia          
                              M_r : 1.765e+06  [N]       Root moment per root chord                       
                          W_{cap} : 7.863e+04  [N]       Weight of spar caps                              
                          W_{web} : 1.042e+04  [N]       Weight of shear web                              
                              \nu : 0.8612               Dummy variable = $(t^2 + t + 1)/(t+1)$           
                          t_{cap} : 0.003034             Non-dim. spar cap thickness                      
                          t_{web} : 0.001787             Non-dim. shear web thickness                     
...
-------------
          Wing, Aircraft |                                                           
             C_{D_{0_w}} : 0.9657   Wing parasitic drag coefficient                  
            C_{L_{wmax}} : 0.3781   Lift coefficient (wing)                          
           \tan(\Lambda) : 0.2423   tangent of wing sweep                            
                  \eta_w : -0.9692  Lift efficiency (diff b/w sectional, actual lift)
          \alpha_{max,w} : -1.348   Max angle of attack                              
                                                                                     
  VerticalTail, Aircraft |                                                           
            C_{L_{vmax}} : 0.02354  Max lift coefficient                             
                     V_c : 0.02247  Cruise velocity                                  
                  \rho_c : 0.0112   Air density (35,000ft)                           
                       e : -0.01265 Span efficiency of vertical tail                 
               \rho_{TO} : -0.02231 Air density (SL))                                
              c_{l_{vt}} : -0.03431 Sectional lift force coefficient (engine out)    
                     V_1 : -0.0917  Minimum takeoff velocity                         
                                                                                     
   LandingGear, Aircraft |                                                           
              W_{0_{lg}} : 0.1138   Weight of aircraft excluding landing gear        
               f_{add,m} : 0.02082  Proportional added weight, main                  
                       K : 0.01638  Column effective length factor                   
                  n_{mg} : -0.06001 Number of main gear struts                       
...
HorizontalTail, Aircraft |                                                           
      ...
      Fuselage, Aircraft |                                                           
                n_{seat} : 0.8458    Number of seats                                 
                      LF : 0.641    Load factor                                      
           W_{avg. pass} : 0.5656   Average passenger weight                         
                f_{padd} : 0.1862   Other misc weight as fraction of payload weight  
                \Delta h : 0.173    Distance from floor to widest part of fuselage   
                     p_s : 0.122    Seat pitch                                       
           \rho_{\infty} : 0.1184   Air density (35,000ft)                           
               W'_{seat} : 0.08276  Weight per seat                                  
             W_{checked} : 0.07542  Ave. checked bag weight                          
             \rho_{skin} : 0.05215  Skin density                                     
                \Delta p : 0.05215  Pressure difference across fuselage skin         
              f_{lugg,1} : 0.05028  Proportion of passengers with one suitcase       
               W_{cargo} : 0.04229  Cargo weight                                     
            ...
            \rho_{floor} : 0.01636  Floor material density                           
              f_{string} : 0.01404  Fractional weight of stringers                   
             W''_{insul} : 0.01334  Weight/area density of insulation material       
               f_{frame} : 0.01003  Fractional frame weight                          
          \sigma_{floor} : -0.01528 Max allowable cap stress                         
           \sigma_{skin} : -0.07219 Max allowable skin stress                        
                     SPR : -0.122   Number of seats per row                          
                                                                                     
                Aircraft |                                                           
                       g : 1.78     Gravitational acceleration                       
                    TSFC : 1.306    Thrust specific fuel consumption                 
                   Range : 1.306    Range                                            
                  V_{ne} : 0.8154   Never exceed velocity                            
                N_{lift} : 0.3877   Wing loading multiplier                          
                  \rho_0 : 0.3842   Air density (0 ft)                               
              \rho_{cap} : 0.3275   Density of spar cap material                     
               f_{w,add} : 0.1063   Wing added weight fraction                       
                     T_e : 0.04585  Engine thrust at takeoff                         
                     r_h : 0.04463  Fractional wing thickness at spar web            
              \rho_{web} : 0.04463  Density of shear web material                    
                 y_{eng} : 0.04222  Engine moment arm                                
                 W_{eng} : 0.02909  Engine weight                                    
                     \mu : 0.02797  Dynamic viscosity (35,000ft)                     
                 d_{fan} : 0.02183  Fan diameter                                     
                       w : -0.01558 Wingbox-width-to-chord ratio                     
      \sigma_{max,shear} : -0.04463 Allowable shear stress                           
            \sigma_{max} : -0.343   Allowable tensile stress                         
                    \rho : -0.5494  Air density (35,000 ft)                          
