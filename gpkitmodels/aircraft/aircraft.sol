...
Allowing negative dual variable(s) as small as -4.46915387664e-10.
...
--------------
                         Aircraft | 
                              C_D : 0.02291 Drag coefficient
                              C_L : 0.4215 Lift coefficient
                          C_{L_w} : 0.4215 Lift coefficient (wing)
                       C_{L_{aw}} : 4.215 Lift curve slope (wing)
                                D : 3.26e+04  [N] Total aircraft drag (cruise)
                         D_{fuse} : 1.118e+04  [N] Fuselage drag
                           D_{ht} : 824.7  [N] Horizontal tail drag
                           D_{vt} : 1107  [N] Vertical tail drag
                         D_{wing} : 1.949e+04  [N] Wing drag
                              L_w : 5.999e+05  [N] Wing lift
                      L_{v_{max}} : 7.336e+05  [N] Maximum load for structural sizing
                              S_w : 136.8  [m**2] Wing reference area
                           V_{TO} : 64.22  [m/s] Takeoff speed
                                W : 5.999e+05  [N] Total aircraft weight
                         W_{fuel} : 5.698e+04  [N] Fuel weight
                         W_{fuse} : 1.687e+05  [N] Fuselage weight
                           W_{ht} : 3606  [N] Horizontal tail weight
                           W_{lg} : 1.827e+04  [N] Weight of landing gear
                          W_{pay} : 1.616e+05  [N] Payload weight
                           W_{vt} : 2362  [N] Vertical tail weight
                         W_{wing} : 1.371e+05  [N] Wing weight
                           W_{zf} : 5.017e+05  [N] Zero fuel weight
                   \bar{c}_{wing} : 4.933  [m] Mean aerodynamic chord (wing)
                      \frac{L}{D} : 18.4 Lift/drag ratio
                              \xi : 0.06136 Takeoff parameter
                           b_{vt} : 3.959  [m] Vertical tail span
                    ...
                    p_{\lambda_v} : 1.6 1 + 2*Tail taper ratio
                     ...
                     x_{CG_{eng}} : 19.6  [m] x-location of engine CG
                      ...
                      x_{CG_{ht}} : 51.77  [m] Horizontal tail CG location
                    ...
                    x_{CG_{wing}} : 19.6  [m] x-location of wing CG
                           ...
                           x_{up} : 29.61  [m] Fuselage upsweep point
                                y : 0.1184 Takeoff parameter
                          z_{bre} : 0.1076 Breguet parameter
                                    
               Fuselage, Aircraft | 
                        A_{floor} : 0.09263  [m**2] Floor beam x-sectional area
                     ...
                     D_{friction} : 1.03e+04  [N] Friction drag
                      D_{upsweep} : 877  [N] Drag due to fuse upsweep
                        ...
                        P_{floor} : 1.137e+06  [N] Distributed floor load
                         R_{fuse} : 1.935  [m] Fuselage radius
                        ...
                        S_{floor} : 5.686e+05  [N] Maximum shear in floor beams
                         ...
                         V_{bulk} : 0.02287  [m**3] Bulkhead skin volume
                        ...
                        V_{floor} : 0.3068  [m**3] Floor volume
                         ...
                         W_{cone} : 9391  [N] Cone weight
                        W_{floor} : 1.375e+04  [N] Floor weight
                        W_{insul} : 4506  [N] Insulation material weight
                  ...
                  \sigma_{\theta} : 1.034e+08  [N/m**2] Skin hoop stress
                      \tau_{cone} : 1.034e+08  [N/m**2] Shear stress in cone
                        ...
                        h_{floor} : 0.05142  [m] Floor I-beam height
                        ...
                        w_{floor} : 3.312  [m] Floor width
                           ...
                           xWcone : 3.868e+05  [N*m] Moment of cone
                            xWfix : 2.802e+04  [N*m] Moment of fixed weights
                          xWfloor : 2.392e+05  [N*m] Moment of floor weight
         ...
         HorizontalTail, Aircraft | 
                             AR_h : 7.729 Horizontal tail aspect ratio
                          C_{D_h} : 0.007194 Horizontal tail drag coefficient
                      C_{D_{0_h}} : 0.005309 Horizontal tail parasitic drag coefficient
                          C_{L_h} : 0.2113 Lift coefficient (htail)
                       C_{L_{ah}} : 4.254 Lift curve slope (htail)
                              K_f : 0.4399 Empirical factor for fuselage-wing interference
                              L_h : 2.422e+04  [N] Horizontal tail downforce
                      L_{{max}_h} : 3.639e+05  [N] Maximum load
                         Re_{c_h} : 8.707e+06 Cruise Reynolds number (Horizontal tail)
                             S.M. : 0.05 Stability margin
                              S_h : 11.02  [m**2] Horizontal tail area
              \Delta x_{{lead}_h} : 33.18  [m] Distance from CG to horizontal tail leading edge
             \Delta x_{{trail}_h} : 35.17  [m] Distance from CG to horizontal tail trailing edge
                           \alpha : 0.04966 Horizontal tail angle of attack
                     \bar{c}_{ht} : 1.371  [m] Mean aerodynamic chord (ht)
                        \lambda_h : 0.2 Horizontal tail taper ratio
                           \tau_h : 0.1458 Horizontal tail thickness/chord ratio
                           b_{ht} : 9.229  [m] Horizontal tail span
                       c_{root_h} : 1.99  [m] Horizontal tail root chord
                        c_{tip_h} : 0.398  [m] Horizontal tail tip chord
                 ...
                 y_{\bar{c}_{ht}} : 2.637  [m] Vertical location of mean aerodynamic chord
            ...
            LandingGear, Aircraft | 
                      ...
                      L_{n_{dyn}} : 6.929e+04  [N] Dyn. braking load, nose gear
                          ...
                          L_{w_n} : 8.044e+04  [N] Static load per wheel (nose)
                           ...
                           W_{ms} : 2447  [N] Weight of main struts
                      ...
                      d_{nacelle} : 2.05  [m] Nacelle diameter
                         ...
                         l_{oleo} : 0.7399  [m] Length of oleo shock absorber
                              r_m : 0.03276  [m] Radius of main gear struts
                              r_n : 0.04869  [m] Radius of nose gear struts
                              t_m : 0.06499  [m] Thickness of main gear strut wall
                              t_n : 0.003202  [m] Thickness of nose gear strut wall
           ...
           VerticalTail, Aircraft | 
                          A_{fan} : 2.405  [m**2] Engine reference area
                           A_{vt} : 0.7056 Vertical tail aspect ratio
                      C_{D_{vis}} : 0.004791 Viscous drag coefficient
                       C_{L_{vt}} : 0.39 Vertical tail lift coefficient
                     ...
                     L_{max_{vt}} : 1.467e+06  [N] Maximum load for structural sizing
                          ...
                          Re_{vt} : 4.194e+07 Vertical tail reynolds number, cruise
                                S : 44.43  [m**2] Vertical tail reference area (full)
                           S_{vt} : 22.21  [m**2] Vertical tail ref. area (half)
                       W_{struct} : 4724  [N] Full span weight
                 ...
                 \Delta x_{trail} : 35.17  [m] Distance from CG to vertical tail trailing edge
                     \bar{c}_{vt} : 6.603  [m] Vertical tail mean aero chord
                 ...
                 z_{\bar{c}_{vt}} : 1.072  [m] Vertical location of mean aerodynamic chord
                   ...
                   Wing, Aircraft | 
                          ...
                          C_{D_w} : 0.0137 Drag coefficient
                      C_{D_{p_w}} : 0.005878 Wing parasitic drag coefficient
                      L_{max_{w}} : 4.343e+06  [N] Maximum load
                             Re_w : 3.133e+07 Cruise Reynolds number (wing)
              ...
              \bar{A}_{fuel, max} : 0.069 Non-dim. fuel area
                     ...
                     f(\lambda_w) : 0.0033 Empirical efficiency function of taper
                      ...
                      y_{\bar{c}} : 9.096  [m] Spanwise location of mean aerodynamic chord
                                    
WingBox, HorizontalTail, Aircraft | 
                          I_{cap} : 2.417e-05 Non-dim spar cap area moment of inertia
                              M_r : 1.641e+05  [N] Root moment per root chord
                          W_{cap} : 2356  [N] Weight of spar caps
                          W_{web} : 220.2  [N] Weight of shear web
                              \nu : 0.8612 Dummy variable = $(t^2 + t + 1)/(t+1)$
                          t_{cap} : 0.005887 Non-dim. spar cap thickness
                          t_{web} : 0.002515 Non-dim. shear web thickness
                                    
  WingBox, VerticalTail, Aircraft | 
                                A : 1.411 Aspect ratio
                          I_{cap} : 7.509e-07 Non-dim spar cap area moment of inertia
                              M_r : 1.38e+05  [N] Root moment per root chord
                          W_{cap} : 2521  [N] Weight of spar caps
                          W_{web} : 853.8  [N] Weight of shear web
                              \nu : 0.8225 Dummy variable = $(t^2 + t + 1)/(t+1)$
                          t_{cap} : 0.0003481 Non-dim. spar cap thickness
                          t_{web} : 0.0007755 Non-dim. shear web thickness
                                    
          WingBox, Wing, Aircraft | 
                          I_{cap} : 2.197e-05 Non-dim spar cap area moment of inertia
                              M_r : 1.877e+06  [N] Root moment per root chord
                          W_{cap} : 8.889e+04  [N] Weight of spar caps
                          W_{web} : 9066  [N] Weight of shear web
                              \nu : 0.8612 Dummy variable = $(t^2 + t + 1)/(t+1)$
                          t_{cap} : 0.004974 Non-dim. spar cap thickness
                          t_{web} : 0.002254 Non-dim. shear web thickness
...
-------------
          Wing, Aircraft | 
            C_{L_{wmax}} : 0.314 Lift coefficient (wing)
           \tan(\Lambda) : 0.07122 tangent of wing sweep
                  \eta_w : -0.2849 Lift efficiency (diff b/w sectional, actual lift)
          \alpha_{max,w} : -0.3855 Max angle of attack
                           
  VerticalTail, Aircraft | 
                     V_c : 0.07235 Cruise velocity
                  \rho_c : 0.03629 Air density (35,000ft)
            C_{L_{vmax}} : 0.02798 Max lift coefficient
                       e : -0.01689 Span efficiency of vertical tail
               \rho_{TO} : -0.04699 Air density (SL))
              c_{l_{vt}} : -0.05989 Sectional lift force coefficient (engine out)
                     V_1 : -0.1499 Minimum takeoff velocity
                           
   LandingGear, Aircraft | 
              W_{0_{lg}} : 0.1583 Weight of aircraft excluding landing gear
                       K : 0.02089 Column effective length factor
               f_{add,m} : 0.01522 Proportional added weight, main
       \tan(\theta_{TO}) : 0.01329 Takeoff pitch angle
               \rho_{st} : 0.01069 Density of 4340 Steel
                       E : -0.01044 Modulus of elasticity, 4340 steel
                  n_{mg} : -0.1101 Number of main gear struts
                 n_{wps} : -0.1195 Number of wheels per strut
                           
HorizontalTail, Aircraft | 
              \Delta x_w : 0.0407 Distance from aerodynamic centre to CG
            |C_{m_{ac}}| : -0.01164 Moment coefficient about aerodynamic centre (wing)
                  \eta_h : -0.01968 Lift efficiency (diff between sectional and actual lift)
                           
      Fuselage, Aircraft | 
                n_{seat} : 0.6934  Number of seats
                      LF : 0.4749 Load factor
           W_{avg. pass} : 0.419 Average passenger weight
                \Delta h : 0.3022 Distance from floor to widest part of fuselage
           \rho_{\infty} : 0.2945 Air density (35,000ft)
                     p_s : 0.1571 Seat pitch
                f_{padd} : 0.1365 Other misc weight as fraction of payload weight
               W'_{seat} : 0.06142 Weight per seat
             W_{checked} : 0.05587 Ave. checked bag weight
              f_{lugg,1} : 0.03725 Proportion of passengers with one suitcase
             \rho_{skin} : 0.03617 Skin density
                \Delta p : 0.03617 Pressure difference across fuselage skin
               W_{cargo} : 0.03133 Cargo weight
                 W_{fix} : 0.02571 Fixed weights (pilots, cockpit seats, navcom)
             \rho_{cone} : 0.02251 Cone material density
             W'_{window} : 0.02242 Weight/length density of windows
              f_{lugg,2} : 0.01862 Proportion of passengers with two suitcases
                N_{land} : 0.01716 Emergency landing load factor
            \rho_{floor} : 0.01716 Floor material density
                 f_{apu} : 0.01325 APU weight as fraction of payload weight
             W''_{floor} : 0.01186 Floor weight/area density
              f_{string} : 0.01141 Fractional weight of stringers
          \sigma_{floor} : -0.01639 Max allowable cap stress
           \sigma_{skin} : -0.05869 Max allowable skin stress
                     SPR : -0.1571 Number of seats per row
                           
                Aircraft | 
                       g : 1.457 Gravitational acceleration
                    TSFC : 1.062 Thrust specific fuel consumption
                   Range : 1.062 Range
                  V_{ne} : 0.7024 Never exceed velocity
                N_{lift} : 0.3287 Wing loading multiplier
                  \rho_0 : 0.3232 Air density (0 ft)
              \rho_{cap} : 0.2764 Density of spar cap material
               f_{w,add} : 0.0873 Wing added weight fraction
                     T_e : 0.07497 Engine thrust at takeoff
                 y_{eng} : 0.0733 Engine moment arm
                     r_h : 0.02909 Fractional wing thickness at spar web
              \rho_{web} : 0.02909 Density of shear web material
                     \mu : 0.02304 Dynamic viscosity (35,000ft)
                 W_{eng} : 0.02127 Engine weight
                 d_{fan} : 0.01803 Fan diameter
                       w : -0.02314 Wingbox-width-to-chord ratio
      \sigma_{max,shear} : -0.02909 Allowable shear stress
            \sigma_{max} : -0.2996 Allowable tensile stress
                    \rho : -0.4212 Air density (35,000 ft)
              V_{\infty} : -1.287 Freestream velocity
